...
const CustomMobileLink = ({
	...
	return (
		...
		>
			{title}
			<span
				className={`h-[2px] inline-block w-0 bg-light absolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 dark:bg-dark ${
					pathname === href ? "w-full" : "w-0"
				}`}
			/>
		</button>
...
const NavBar = (props: Props) => {
	...
	return (
		<header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:ps-12 sm:px-8">
			<button
